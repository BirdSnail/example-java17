...
import birdsnail.example.entity.Goods;
import birdsnail.example.entity.Labor;
import birdsnail.example.entity.PaymentHackData;
...
public class LoopColumnTableRenderPolicyTest {
    ...
    String resource = "src/main/resources/template/render_loopcolumn.docx";
    ...
    public void init() {
        ...
        good.setPicture(Pictures.ofLocal("src/main/resources/earth.png").size(24, 24).create());
        goods.add(good);
        goods.add(good);
        goods.add(good);
        goods.add(good);
